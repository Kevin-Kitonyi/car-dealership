		...
		<section id="home" class="welcome-hero">
				    ...
				    <nav class="navbar navbar-default bootsnav  navbar-sticky navbar-scrollspy"  data-minus-value-desktop="70" data-minus-value-mobile="55" data-speed="1000">
				        ...
				        <div class="container">
				            ...
				            <div class="navbar-header">
				                ...
				                <a class="navbar-brand" href="index.html">CarDealership<span></span></a>
			...
			<div class="container">
				<div class="welcome-hero-txt">
					<h2>get your desired car for a resonable price</h2>
					<p>
			...
			<div class="container">
				...
				<div class="footer-copyright">
					<div class="row">
						<div class="col-sm-6">
							<p>
								&copy; copyright.designed and developed by Kevin K</p><!--/p-->
						</div>
						<div class="col-sm-6">
